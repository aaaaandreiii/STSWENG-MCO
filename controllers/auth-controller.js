...
console.log('[DB] employee collection name:', Employee.collection.collectionName);
...
const controller = {
    ...
    authenticate: async function (req, res) {
        ...
        try {
            ...
            if (!user.hasAccess) {
                console.warn('[AUTH][FAIL] no access', { ...meta, hasAccess: user.hasAccess });
            ...
            console.info('[AUTH][OK] login', { ...meta, isAdmin: req.session.isAdmin });
