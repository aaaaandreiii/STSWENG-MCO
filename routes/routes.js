...
app.get("/admin/employee", 
  ensureAuthenticated,
  requireRoles(['admin']),
  adminController.getAllEmployees
);

app.get("/admin/employee/current", 
  ensureAuthenticated,
  requireRoles(['admin']),
  adminController.getAllCurrentEmployees
);

app.get("/admin/employee/former", 
  ensureAuthenticated,
  requireRoles(['admin']),
  adminController.getAllFormerEmployees
);

app.get("/admin/employee/:id", 
  ensureAuthenticated,
  requireRoles(['admin']),
  adminController.getEmployee
);

app.put("/admin/employee/:username", 
  ensureAuthenticated,
  requireRoles(['admin']),
...
//settings
app.get("/settings/event", 
  ensureAuthenticated,
  requireRoles(['admin']),
  adminController.getEventSettings
);

app.get("/settings/event/discount", 
  ensureAuthenticated,
  requireRoles(['admin']),
  adminController.getDiscounts
);

app.post("/settings/event/discount", 
  ensureAuthenticated,
  requireRoles(['admin']),
...
// event-tracker form
app.get("/event-tracker/create", 
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
  eventController.getCreateEvent,
);

app.post("/event-tracker/submit", 
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
  eventController.postCreateEvent
);

app.get("/event-tracker/edit/:id", 
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
  eventController.getEditEvent,
);

app.put("/event-tracker/cancel", 
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
  eventController.putCancelEvent,
);

app.get("/event-tracker/print/:id", 
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
  eventController.getPrintEvent,
);

app.put("/event-tracker/finish", 
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
...
app.get("/event-tracker/get/food", 
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
  eventController.getFood,
);

app.get("/event-tracker/get/event", 
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
  eventController.getEvent,
);

app.get("/event-tracker/get/charges", 
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
  eventController.getCharges,
);
app.get("/event-tracker/get/packages", 
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
  eventController.getPackages,
);
app.get("/event-tracker/check/event-availability",
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
...
app.get("/event-tracker/calendar/:year/:month",
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
...
app.get("/event-tracker/pencilbookings/search",
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
  eventController.getPencilBookingsSearch,
);
app.get("/event-tracker/pencilbookings/filter",
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
...
app.get("/event-tracker/reservations/search",
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
  eventController.getReservationsSearch,
);
app.get("/event-tracker/reservations/filter",
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
...
app.get("/event-tracker/pastevents", 
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
  eventController.getPastEvents
);

app.get("/event-tracker/pastevents/search",
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
  eventController.getPastEventsSearch,
);

app.get("/event-tracker/pastevents/filter",
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
...
app.get("/event-tracker/cancelled", 
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
  eventController.getCancelledEvents);

app.get("/event-tracker/cancelled/search",
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
  eventController.getCancelledEventsSearch,
);
app.get("/event-tracker/cancelled/filter",
  ensureAuthenticated,
  requireRoles(['admin', 'manager', 'frontdesk']),
