      ...
      if (currentDay > 0 && currentDay <= daysInMonth) {
        ...
        eventArray[week].push({
          ...
          aftGar: dayEvents.some(
            (e) =>
              e.eventVenues?.includes("Garden") && e.eventTime === "Afternoon",
          ),
          aftSun: dayEvents.some(
            (e) =>
              e.eventVenues?.includes("Sunroom") && e.eventTime === "Afternoon",
          ),
          aftTer: dayEvents.some(
            (e) =>
              e.eventVenues?.includes("Terrace") && e.eventTime === "Afternoon",
          ),
